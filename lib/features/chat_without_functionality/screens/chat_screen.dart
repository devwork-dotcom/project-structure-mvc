...
class ChatWithoutFunc extends StatelessWidget {
  ...
  const ChatWithoutFunc({super.key, required this.userId});
...
//         decoration: BoxDecoration(
//           color: message.isMe ? AppColors.containerSoft : AppColors.containerSoft,
          ...
          children: [
            if (!message.isMe) ...[
              CircleAvatar(
                ...
                ), // Add senderAvatar to ChatMessage model
              ),
              SizedBox(width: 8.w),
            ],
            Flexible(
