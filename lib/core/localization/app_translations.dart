...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'en_US': {
      ...
      AppText.startManagingYourBusinessSmarter:
          'Start managing your business smarter in just a few steps.',
      ...
      AppText.pleaseVerifyYourEmailAddressToGetStarted:
      ...
      AppText.enterYourEmailAccountToResetYourPassword:
          'Enter your email account to reset your password',
      AppText.resetYourPassword: 'Reset your password',
      AppText.thePasswordMustBeDifferentThanBefore:
      ...
      AppText.passwordMustBeAtLeast6Characters:
          'Password must be at least 6 characters long.',
      AppText.passwordMustBeAtLeast8Characters:
